...
//	private Team mTeam;
    ...
    public static String strImageDir  = System.getProperty("user.dir") + File.separator + "src"
                                        + File.separator + "frogger" + File.separator + "images" + File.separator;

    // project directory with fonts
    public static String strFontDir  = System.getProperty("user.dir") + File.separator + "src"
            + File.separator + "frogger" + File.separator + "fonts" + File.separator;
    ...
    // Set initial position for this sprite to be used when Frog is respawned in the current level
    public void initPos() {
